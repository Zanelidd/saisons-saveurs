                                    ...
                                    <RecipePanel recipeId={meal.id} diet={diet} persons={persons} accent={accent}>
                                        ...
                                        {meal.kcal > 0 && (
                                            <div className={s.macros}>
                                                <span
                                                    className={`${s.pill} ${s.pillKcal}`}>{t("meal.kcal", {value: meal.kcal})}</span>
                                                <span
                                                    className={`${s.pill} ${s.pillP}`}>{t("meal.protein", {value: meal.proteines})}</span>
                                                <span
                                                    className={`${s.pill} ${s.pillG}`}>{t("meal.carbs", {value: meal.glucides})}</span>
                                                <span
                                                    className={`${s.pill} ${s.pillL}`}>{t("meal.fat", {value: meal.lipides})}</span>
                                            </div>
                                        )}
